...
Using the batchTableMaker_ver03.sh script, specify the container with "-c" and
a grep term with "-g"
...
The processed and indexed bam files as well as the readStats were moved to the object store in the CutAndRunBams folder
